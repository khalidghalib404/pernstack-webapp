  ...
  return (
    ...
    flex items-center  justify-center'>
      <div className='bg-white rounded-2xl shadow-xl w-full max-w-lg p-8'>
                ...
                <h1 className='text-4xl font-bold text-grey-200 mb-6'>Task wergfd243uytuyfuygdfgfsdgs24ghfhgfhgjgu</h1>  
        ...
        <form  onSubmit={addTodo} className=' flex items-center gap-2 shadow-md shadow-sm border border-gray-200 p-2 rounded-lg'>
          ...
          required/>
          <button type='submit' className='bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md font-medium  curser-pointer'>Add Task</button>
        </form>
      </div>
